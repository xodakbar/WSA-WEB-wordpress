...
import FactCard from '../components/FactCard'; // Nuevo componente
...
export default function Home() {
  return (
    <>
      ...
      {/* Curva invertida */}
      <div
        className="relative w-full overflow-hidden leading-none rotate-180"
        aria-hidden="true"
        style={{ lineHeight: 0 }}
      >
        <svg
      ...
      >
        ...
        {/* Contenido principal */}
        <div className="relative z-10 max-w-5xl mx-auto px-8 pt-24 pb-16 text-center text-white/90">
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-6 drop-shadow-md">
            We Work every day building confidence.
          </h2>
          <p className="italic text-xl md:text-2xl text-white/80 drop-shadow-sm">
            Growing together!
          </p>
        </div>

        {/* Barra inferior con FactCards animados */}
        <div className="relative z-10 w-full bg-black/40 backdrop-blur-md px-12 py-8 flex justify-center space-x-32 text-white/90">
