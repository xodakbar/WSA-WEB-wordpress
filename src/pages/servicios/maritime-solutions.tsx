...
import maritimeLogisticImg from '../../assets/logistic/foto1.png';
...
const otherServices = [
  ...
  { id: 'maritime-logistic', title: 'MARITIME LOGISTIC', subtitle: 'LAST MILE DELIVERY', image: maritimeLogisticImg },
...
export default function MaritimeSolutions() {
  ...
  const subServices = [
    { title: "Provisions and bonds", desc: "Ensuring vessels are fully equipped with all required provisions and bonds." },
    { title: "Technical assistance and products", desc: "Providing specialized products and technical support tailored for marine operations." },
    { title: "Workshop coordination", desc: "Organizing and managing workshops for vessel maintenance and repairs." },
    { title: "Diving service coordination", desc: "Arranging professional diving services for inspections and maintenance." },
    { title: "Marine surveyor arrangement", desc: "Scheduling certified marine surveyors to ensure compliance and safety." },
  ];
