    ...
    <div className="bg-gray-50 min-h-screen flex flex-col font-sans text-gray-900">
      ...
      <main className="flex-grow max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-6">
            ...
            <motion.button type="submit" disabled={sending}
              className={`w-full py-4 mt-4 text-white font-semibold rounded-2xl transition-all duration-300 ${
                sending ? 'bg-blue-300 cursor-not-allowed shadow-none' : 'bg-gradient-to-r from-blue-600 to-blue-800 shadow-lg hover:from-blue-700 hover:to-blue-900'
              }`}
            ...
            {success && (
              <motion.p className="mt-6 text-center text-green-700 font-semibold"
        ...
        <motion.section variants={fadeInUp} initial="hidden" animate="visible" transition={{ delay: 0.3 }}>
          <h2 className="text-4xl font-serif font-bold mb-12 text-center lg:text-left" style={{ fontFamily: "'Playfair Display', serif" }}>
          ...
          <div className="space-y-12">
            {[{
              ...
              <motion.div key={email} className="flex items-center bg-white rounded-2xl shadow-md p-6 gap-8 cursor-default"
                whileHover="hover" variants={cardHover} initial="rest" animate="rest"
              >
                <motion.img src={qr} alt={alt} className="w-24 h-24 rounded-xl shadow" loading="lazy"
                ...
                <div>
                  ...
                  <p className="flex items-center gap-2 text-gray-700 text-lg font-medium mb-1">
                    ...
                    <a href={whatsapp} target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-700">{phone}</a>
                  </p>
          ...
          <motion.div className="mt-20 flex justify-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 0.9, y: 0 }} transition={{ duration: 0.7, delay: 0.5 }}>
            <img src={WSALogo} alt="WSA Agencies Maritime Services Logo" className="h-24" loading="lazy" />
          </motion.div>
        </motion.section>
      </main>
